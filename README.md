...
Latest DP8: **52,281.16 total tok/s** at concurrency **32** (`20260808T160001Z`).
Latest PCP8: **failed (-1.00 total tok/s)** (`20260808T160001Z`).

Latest DP8 single-request TTFT: **success**, **16 serial samples/length** (`20260808T160001Z`).
Latest PCP8 single-request TTFT: **failed** (`20260808T160001Z`).
...
Latest PCP8 semantic mixed-length result: C8 **failed**; C64 **failed** (`20260808T160001Z`).
