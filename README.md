...
Latest DP8: **73,931.49 total tok/s** at concurrency **64** (`20260829T125014Z`).
Latest PCP8: **66,949.96 total tok/s** at concurrency **64** (`20260829T125014Z`).

Latest DP8 single-request TTFT: **partial**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260829T125014Z`).
Latest PCP8 single-request TTFT: **success**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260829T125014Z`).
...
| --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `1009b911a0bd` | 2026-08-29 12:50 | 73,931.49 | 66,949.96 | 6,259.00 | 40.81 | DP4/TP2/EP8 C256 peak 1s (>=90% active) | 985.48 | 187.29 | 2,037.33 | 352.91 | 4,326.82 | 672.06 | 9,704.17 | 1,498.82 | 23,612.52 | 3,487.57 | failed | 8,824.83 |
| `bb35f72026a8` | 2026-08-27 13:34 | 73,905.10 | 66,892.92 | 6,220.00 | 40.92 | DP4/TP2/EP8 C256 peak-active P50 | 990.61 | 189.87 | 2,047.08 | 353.69 | 4,359.17 | 685.63 | 9,803.48 | 1,490.10 | 23,959.69 | 3,536.10 | 63,767.46 | 8,874.40 |
| `ed5d52b7cb6d` | 2026-08-27 11:35 | — | — | 6,233.00 | 40.86 | DP4/TP2/EP8 C256 peak-active P50 | — | — | — | — | — | — | — | — | — | — | — | — |
| `ed5d52b7cb6d` | 2026-08-27 11:29 | — | — | -1.00 | — | failed | — | — | — | — | — | — | — | — | — | — | — | — |
...
Latest PCP8 semantic mixed-length result: C8 **46,704.97 input tok/s**, TTFT P50/P90/P99 **1,687.55/2,908.37/4,199.46 ms**; C64 **49,215.34 input tok/s**, TTFT P50/P90/P99 **13,811.33/17,223.11/18,461.96 ms** (`20260829T125014Z`).
...
| --- | --- | --- | --- | --- | --- | --- |
| `1009b911a0bd` | `f16a7f760630` | 2026-08-29 14:04 | **failed** | **failed** | **46,704.97 tok/s**<br>P50/P90/P99: 1,687.55/2,908.37/4,199.46 ms | **49,215.34 tok/s**<br>P50/P90/P99: 13,811.33/17,223.11/18,461.96 ms |
| `bb35f72026a8` | `f16a7f760630` | 2026-08-27 15:06 | **34,308.67 tok/s**<br>P50/P90/P99: 1,977.81/5,097.90/7,712.75 ms | **66,370.02 tok/s**<br>P50/P90/P99: 9,720.98/14,969.19/19,078.99 ms | **54,393.79 tok/s**<br>P50/P90/P99: 1,534.40/2,271.28/2,966.94 ms | **59,128.94 tok/s**<br>P50/P90/P99: 11,661.17/13,845.98/14,877.25 ms |
