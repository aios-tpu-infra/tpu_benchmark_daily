...
Latest DP8: **79,372.02 total tok/s** at concurrency **64** (`20260914T122239Z`).
Latest PCP8: **failed (-1.00 total tok/s)** (`20260914T122239Z`).

Latest DP8 single-request TTFT: **partial**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260914T122239Z`).
Latest PCP8 single-request TTFT: **failed** (`20260914T122239Z`).
...
Latest PCP8 semantic mixed-length result: C8 **failed**; C64 **failed** (`20260914T122239Z`).
