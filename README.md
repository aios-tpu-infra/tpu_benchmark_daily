...
Latest DP8: **73,905.10 total tok/s** at concurrency **32** (`20260827T133447Z`).
Latest PCP8: **66,892.92 total tok/s** at concurrency **16** (`20260827T133447Z`).

Latest DP8 single-request TTFT: **success**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260827T133447Z`).
Latest PCP8 single-request TTFT: **success**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260827T133447Z`).
...
Latest PCP8 semantic mixed-length result: C8 **54,393.79 input tok/s**, TTFT P50/P90/P99 **1,534.40/2,271.28/2,966.94 ms**; C64 **59,128.94 input tok/s**, TTFT P50/P90/P99 **11,661.17/13,845.98/14,877.25 ms** (`20260827T133447Z`).
