...
Latest DP8: **44,266.16 total tok/s** at concurrency **128** (`20260731T160001Z`).
Latest PCP8: **57,719.11 total tok/s** at concurrency **16** (`20260731T160001Z`).

Latest DP8 single-request TTFT: **success**, **16 serial samples/length** (`20260731T160001Z`).
Latest PCP8 single-request TTFT: **success**, **16 serial samples/length** (`20260731T160001Z`).
