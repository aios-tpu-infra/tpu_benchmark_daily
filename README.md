...
Latest DP8: **52,395.10 total tok/s** at concurrency **64** (`20260820T051256Z`).
Latest PCP8: **50,234.11 total tok/s** at concurrency **64** (`20260820T063948Z`).

Latest DP8 single-request TTFT: **success**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260820T051256Z`).
Latest PCP8 single-request TTFT: **success**, **serial samples/length: 8K/16K/32K=16, 64K/128K/252K=4** (`20260820T063948Z`).
...
Latest PCP8 semantic mixed-length result: C8 **42,015.65 input tok/s**, TTFT P50/P90/P99 **2,011.13/2,899.24/3,876.50 ms**; C64 **45,809.18 input tok/s**, TTFT P50/P90/P99 **15,063.58/17,799.03/19,135.66 ms** (`20260820T063948Z`).
