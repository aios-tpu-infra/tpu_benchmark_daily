...
Latest DP8: **43,894.34 total tok/s** at concurrency **256** (`20260731T031822Z`).
Latest PCP8: **57,665.48 total tok/s** at concurrency **16** (`20260731T031822Z`).

Latest DP8 single-request TTFT: **success**, **16 serial samples/length** (`20260731T031822Z`).
Latest PCP8 single-request TTFT: **success**, **16 serial samples/length** (`20260731T031822Z`).
